...
const connectionPool = _mysql2.default.createPool({
  connectionLimit: 10,
  host: _config2.default.mysqlHost,
  user: _config2.default.mysqlUserName,
  password: _config2.default.mysqlPass,
  database: _config2.default.mysqlDatabase
});
